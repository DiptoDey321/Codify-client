...
function Register() {
    ...
    const {createUser,prodiverLogin,updateUserProfile,gitLogin} = useContext(AuthContext)
  ...
  return (
    <div>
        <section className=" bg-gray-50 dark:bg-gray-900 pb-48">
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-[30rem] xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={handleGithubSignIn} className='flex items-center gap-x-3 border px-3 py-2.5 rounded-md'>
                        ...
                        <form onSubmit={handleRegisterForm} className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="flex items-start">
                                <div className="flex items-center h-5">
                                    <input onClick={termsHandler} id="terms" aria-describedby="terms" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" required=""/>
                                </div>
